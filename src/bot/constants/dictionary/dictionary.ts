...
const ptBr: DictionaryKeys = {
  MSG_GREETING: `𝖡𝖾𝗆-𝗏𝗂𝗇𝖽@ 𝖺𝗈 ${ROOM_TITLE} ${APP_VERSION}!`,
  ...
  MSG_GAME_INFO_3: `𝖭𝖺 𝗏𝖾𝗋𝗌ã𝗈 𝖺𝗍𝗎𝖺𝗅 (${APP_MINOR_VERSION}) estamos testando algumas 𝗮𝗹𝘁𝗲𝗿𝗮çõ𝗲𝘀 𝗻𝗮 𝗳í𝘀𝗶𝗰𝗮, como a 𝘥𝘪𝘮𝘪𝘯𝘶𝘪çã𝘰 𝘥𝘢 𝘣𝘰𝘭𝘢 e o 𝘢𝘶𝘮𝘦𝘯𝘵𝘰 𝘥𝘰 𝘣𝘰𝘶𝘯𝘤𝘦 entre os jogadores.`,
  MSG_GAME_INFO_4: `𝖤 𝗇𝖺 𝗏𝖾𝗋𝗌ã𝗈 𝖺𝗇𝗍𝖾𝗋𝗂𝗈𝗋 (${APP_PREVIOUS_MINOR_VERSION}) 𝗅𝖺𝗇ç𝖺𝗆𝗈𝗌 𝗈 𝘁𝗲𝗮𝗺 𝗰𝗵𝗮𝘁 e o fim 𝖽𝖾 𝗉𝖺𝗋𝗍𝗂𝖽𝖺 𝗉𝗈𝗋 𝖽𝗂𝖿𝖾𝗋𝖾𝗇ç𝖺 𝖽𝖾 𝗉𝗈𝗇𝗍𝗈𝗌 (𝘢𝘵𝘶𝘢𝘭𝘮𝘦𝘯𝘵𝘦 𝘧𝘪𝘹𝘰 𝘦𝘮 20).`,
  ...
  MSG_CLOSED_ROOM_1: '𝖭𝗈𝗌𝗌𝖺 𝗦𝗔𝗟𝗔 𝗢𝗙𝗜𝗖𝗜𝗔𝗟 𝖺𝖻𝗋𝖾 às noites, 𝘀𝗼𝗯 𝗱𝗲𝗺𝗮𝗻𝗱𝗮.',
  MSG_CLOSED_ROOM_2: `𝖥𝗂𝗊𝗎𝖾 𝗉𝗈𝗋 𝖽𝖾𝗇𝗍𝗋𝗈 das 𝘯𝘰𝘷𝘪𝘥𝘢𝘥𝘦𝘴 do HaxRugby 𝖾𝗆 𝗇𝗈𝗌𝗌𝗈 𝗗𝗜𝗦𝗖𝗢𝗥𝗗 👉 ${LINK_DISCORD}`,
  MSG_CLOSED_ROOM_3: 'As salas serão 𝘥𝘪𝘷𝘶𝘭𝘨𝘢𝘥𝘢𝘴 no canal #𝘀𝗮𝗹𝗮𝘀.',
