...
const ptBr: DictionaryKeys = {
  ...
  MSG_GAME_INFO_3: `N𝖺 𝗏𝖾𝗋𝗌ã𝗈 ${APP_PREVIOUS_MINOR_VERSION} 𝗌𝗎𝖻𝗂𝗆𝗈𝗌 𝗈 𝖻𝗈𝗍 𝗉𝖺𝗋𝖺 𝗎𝗆 𝗩𝗣𝗦 𝖾 𝖺𝖽𝗂𝖼𝗂𝗈𝗇𝖺𝗆𝗈𝗌 𝗲𝗳𝗲𝗶𝘁𝗼 𝗱𝗲 𝗽𝗼𝗻𝘁𝘂𝗮çã𝗼 𝗉𝖺𝗋𝖺 𝖺𝗌 𝗉𝗈𝗇𝗍𝗎𝖺çõ𝖾𝗌!`,
  MSG_GAME_INFO_4: `𝖤 𝗇𝖺 𝗏𝖾𝗋𝗌ã𝗈 ${APP_MINOR_VERSION} 𝗅𝖺𝗇ç𝖺𝗆𝗈𝗌 𝗈 𝗆𝖺𝗉 𝗍𝖺𝗆𝖺𝗇𝗁𝗈 𝗕𝗶𝗴! 𝖠𝗂𝗇𝖽𝖺 𝖾𝗌𝗍á 𝖾𝗆 𝖿𝖺𝗌𝖾 𝖽𝖾 𝗍𝖾𝗌𝗍𝖾𝗌 𝖾 𝖺𝗃𝗎𝗌𝗍𝖾𝗌...`,
