...
const ptBr: DictionaryKeys = {
  ...
  MSG_GAME_INFO_3: `𝖭𝖺 𝗏𝖾𝗋𝗌ã𝗈 𝟬.𝟭𝟯 𝖼𝗈𝗆𝖾ç𝖺𝗆𝗈𝗌 𝖺 𝗍𝗋𝖺𝖻𝖺𝗅𝗁𝖺𝗋 𝗈 𝗲𝘀𝘁𝗶𝗹𝗼 𝗱𝗼 𝗰𝗮𝗺𝗽𝗼!`,
  MSG_GAME_INFO_4: `𝖭𝖺𝗌 𝗏𝖾𝗋𝗌õ𝖾𝗌 𝘃𝟬.𝟭𝟭 𝖾 𝘃𝟬.𝟭𝟮 𝗂𝗇𝗍𝗋𝗈𝖽𝗎𝗓𝗂𝗆𝗈𝗌 𝗈 𝗜𝗺𝗽𝗲𝗱𝗶𝗺𝗲𝗻𝘁𝗼 (𝖼𝗈𝗆𝖺𝗇𝖽𝗈 !𝗶𝗺𝗽), 𝖺 𝗩𝗮𝗻𝘁𝗮𝗴𝗲𝗺 𝖾 𝗈 𝗣𝗲𝗻𝗮𝗹.`,
